...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Check credentials
      if (formData.email === 'vsragavan949@gmail.com' && formData.password === 'Admin@123') {
        ...
        setErrors(prev => ({
          ...prev,
          general: 'Invalid email or password. Please use: vsragavan949@gmail.com / Admin@123'
        }))
      }
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="rounded-md shadow-sm space-y-4">
            <div>
              ...
              <input
                ...
                } placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-white bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:z-10 sm:text-sm`}
          ...
          {errors.general && (
            <div className="rounded-md bg-red-50 dark:bg-red-900 p-4">
              <div className="text-sm text-red-700 dark:text-red-200">{errors.general}</div>
            </div>
          )}
